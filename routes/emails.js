								...
								<td style="padding: 0 2.5em 3em; text-align: left;">
									<div class="text">
										...
										<h3>Nous vous confirmons votre inscription sur <a
												...
												href="http://dressingfmr.com">dressingfmr.com</a>, vous pouvez dès à présent vous
										...
										<h3>A très vite sur Mummy's Food !</h3>
									</div>
								</td>
							</tr>
						</table>
		...
		L11.01,195.989c1.717,0.617,3.56,1.096,5.49,1.096h197.667c2.866,0,5.554-0.873,7.891-2.175L149.207,126.901z" />
				...
				<tr>
					<td style="text-align: center; font-size: 10px; background: #f7f0e6;">
						<p style="color: #cecece">Ceci est un email automatique, merci de ne pas y répondre.</a></p>
					</td>
				</tr>
			</table>
						...
						<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
							<tr>
								<td style="padding: 0 2.5em 3em; text-align: left;">
									<div class="text">
										<h2>Bonjour Zora,</h2>
										<h3>${req.body.name} a une question à vous poser, voici le détail :</h3>
										<h3>${req.body.message}</h3>
										<p style="text-align:center; margin: 40px 0; font-weight: 600;"><a
												href="mailto:${req.body.email}" class="btn btn-primary">Répondre</a></p>
...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="x-apple-disable-message-reformatting">
	<title>Mummy's Food - Commande confirmée</title>
								...
								<td style="padding: 0 2.5em 1em; text-align: left;">
									<div class="text">
										...
										<h3>Merci d'avoir passé commande sur <a
												style="color: #ffdc8c !important; font-weight: 500;"
												href="http://dressingfmr.com">dressingfmr.com</a>, voici le détail :</h3>
									</div>
								</td>
							</tr>
							<tr>
								...
								<tr>
									<td style="padding: 0 2.5em 3em; text-align: left;">
										<div class="text">
											...
											<h3>Pour réinitialiser votre mot passe, veuillez cliquer sur le lien suivant :</h3>
											<p style="text-align:center; margin: 40px 0; font-weight: 600;"><a
													href="http://localhost:4200/#/reset-password?email=${req.body.email}" class="btn btn-primary">Réinitialiser mon mot de passe</a></p>
											<h3>A très vite chez Mummy's Food !</h3>
										</div>
									</td>
								</tr>
							</table>
